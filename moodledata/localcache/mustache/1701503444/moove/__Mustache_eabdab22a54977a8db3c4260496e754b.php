...
class __Mustache_eabdab22a54977a8db3c4260496e754b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCc8904b2a04e192fab294736ccad5d52($context, $indent, $value);
        $value = $context->find('unauthenticateduser');
        if (empty($value)) {
...
';
    ...
    private function section5d8bee04742cd608aa9531ec55f179f7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <a class="btn btn-warning font-weight-bold" href="{{url}}">{{#str}} login, core {{/str}}</a>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <a class="btn btn-warning font-weight-bold" href="';
...
';
    ...
    private function sectionCc8904b2a04e192fab294736ccad5d52(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5d8bee04742cd608aa9531ec55f179f7($context, $indent, $value);
                $buffer .= $indent . '        </span>
';
                $context->pop();
            }
